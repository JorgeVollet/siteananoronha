...
export const FOOTER_FIELDS: ContentField[] = [
  {
    ...
    label: 'WhatsApp',
    type: 'text',
    placeholder: '5521996621363',
    hint: 'Apenas números, com código do país e DDD. Ex: 5521996621363',
  },
  {
    key: 'email',
    label: 'Email comercial',
    type: 'text',
    placeholder: 'contato@analauraarquitetura.com.br',
  },
  {
    key: 'instagram',
    label: 'URL do Instagram',
    type: 'url',
    placeholder: 'https://instagram.com/analauraarquitetura',
  ...
  },
  {
    ...
    type: 'text',
    placeholder: 'Barra da Tijuca - RJ',
  },
  {
    key: 'crea',
